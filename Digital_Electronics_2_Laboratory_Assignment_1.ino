...
#define LED1 PA3   // Blinks at 1Hz (Step 3)
#define LED2 PA4   // Blinks when button held (Step 5)
#define LED3 PA5   // Toggles on button press (Step 6)
#define BUTTON PB13 // Onboard button (active-low)
